...
public class BoardFileDeleteController implements PageController {
  ...
  public BoardFileDeleteController(TransactionManager txManager, BoardDao boardDao,
...
//      request.setAttribute("viewUrl", "redirect:../view?category=" + category + "&no=" + file.getBoardNo());
