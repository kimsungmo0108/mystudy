...
import bitcamp.myapp.controller.assignmnet.AssignmentAddController;
...
public class DispatcherServlet extends HttpServlet {
  ...
  public void init() throws ServletException {
    ...
    controllerMap.put("/board/file/delete", new BoardFileDeleteController(txManager, boardDao,
        attachedFileDao, boardUploadDir));
  }
