...
<h1>회원</h1>
      ...
      <div>
          ...
          <a href='/upload/${member.photo}'><img src='/upload/${member.photo}' height='80px'></a><br> <input name='photo' type='file'>
          </c:if>
          <c:if test="${empty member.photo}">
          <a href="/img/default-photo.jpg"><img src="/img/default-photo.jpg" height='80px'></a><br> <input name='photo' type='file'>
          </c:if>
      </div>
      <div>
